...
def submit(submit_data):
  ...
  http_conn    = httplib.HTTPConnection("bb-oftl-hrd.appspot.com:80")
  ...
  if response.status != 200:
    ...
    print
    print "Please copy/paste the contents of this window and PM to elessar9 or mardaed in the"
...
if __name__ == '__main__':
  try:
    ...
    replays_submitted = os.path.join(replay_dir, "OFTL-NEW_Submitted.txt")
